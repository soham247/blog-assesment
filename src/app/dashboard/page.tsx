  ...
  const stats = [
    {
      ...
      description: `${publishedPosts?.total || 0} published, ${draftPosts?.total || 0} drafts`,
      icon: FileText,
      color: 'text-blue-600',
      bgColor: 'bg-blue-100',
    },
              ...
              <div className="space-y-4">
                {recentPosts?.posts?.length ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <h3 className="mt-4 text-sm font-medium text-foreground">No posts yet</h3>
              ...
              <div className="space-y-4">
                {categories?.length ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <h3 className="mt-4 text-sm font-medium text-foreground">No categories yet</h3>
                    <p className="mt-2 text-sm text-muted-foreground">
